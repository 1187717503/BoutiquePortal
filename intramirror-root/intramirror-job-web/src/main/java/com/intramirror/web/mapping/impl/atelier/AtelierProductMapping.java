 ...
 */
@Service(value = "atelierProductMapping")
public class AtelierProductMapping implements IProductMapping {

    // logger
    private static final Logger logger = Logger.getLogger(AtelierProductMapping.class);
