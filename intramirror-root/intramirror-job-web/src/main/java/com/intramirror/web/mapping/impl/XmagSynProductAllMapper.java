...
public class XmagSynProductAllMapper implements IProductMapping {
    ...
    public ProductOptions mapping(Map<String, Object> bodyDataMap) {
        ...
        try {
            ...
            logger.info(
                    "XmagSynProductAllMapperMapping,errorMessage:" + ExceptionUtils.getExceptionDetail(e) + ",bodyDataMap:" + new Gson().toJson(bodyDataMap));
            if (conn != null) {
                conn.close();
            }
            e.printStackTrace();
     ...
     * @author 123
     */
    public ProductEDSManagement.ProductOptions handleMappingData(Map<String, Object> product, ProductEDSManagement.VendorOptions vendorOptions)
            throws Exception {
        ProductEDSManagement.ProductOptions productOptions = productEDSManagement.getProductOptions();
        //数据解析
        if (null != product && 0 < product.size()) {
            ...
            productOptions.setCategory1(type.toLowerCase());
            productOptions.setCategory2(category.toLowerCase());
            productOptions.setCategory3(SubCategory);
        ...
        productOptions.setCode(productOptions.getCode() + "_" + productOptions.getColorCode());
        ...
        /*if(StringUtils.isNotBlank(productOptions.getCategory1())
        	...
        	productOptions.setCategory2("xmag");
		}*/
