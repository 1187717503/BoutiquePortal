...
public class AiDucaSynProductMapping implements IProductMapping{
	...
	public ProductOptions mapping(Map<String, Object> dataMap) {
		logger.info("job aiduca product mapping param dataMap:"+ new Gson().toJson(dataMap));
...
//    		productOptions.setSeasonCode("A17");
    		...
    		/** designer id 就是BrandCode BrandId*/
...
//            productOptions.setCategoryId("1532");
            logger.info("job mapping AiDuca productOptions : " + new Gson().toJson(productOptions));
    	}
