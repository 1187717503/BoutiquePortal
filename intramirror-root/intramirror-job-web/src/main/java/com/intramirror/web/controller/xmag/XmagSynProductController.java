...
<<<<<<< HEAD
            ...
            while (true) {
                String appendUrl =
                        url + "?DBContext=" + DBContext + "&BrandId=" + BrandId + "&SeasonCode=" + "&StartIndex=" + StartIndex + "&EndIndex=" + EndIndex
                                + "&Key=" + Key + "&CategoryId=" + CategoryId;
                if (StringUtils.isNotBlank(byDate)) {
                    appendUrl = appendUrl + byDate;
                }
                ...
                if (StringUtils.isNotBlank(json)) {
                    ...
                    logger.info(
                            "XmagSynProductAllControllerSynProduct,convertJsonObjectToList,productListSize:" + productList.size() + ",productList:" + JSONObject
                                    .toJSONString(productList));
                    ...
                    if (productList != null && productList.size() > 0) {
                        ...
                        for (Map<String, Object> product : productList) {
                            ...
                            logger.info(
                                    "XmagSynProductAllControllerSynProduct,convertJson,end,product:" + JSONObject.toJSONString(product) + ",convertProductList:"
                                            + JSONObject.toJSONString(convertProductList));
                            ...
                            for (Map<String, Object> newProduct : convertProductList) {
                                ...
                                logger.info("XmagSynProductAllControllerSynProduct,initParam,productOptions:" + new Gson().toJson(productOptions)
                                        + ",vendorOptions:" + new Gson().toJson(vendorOptions) + ",eventName:" + eventName + ",mqDataMap:" + JSONObject
                                        .toJSONString(mqDataMap));

                                // 线程池
                                logger.info("XmagSynProductAllControllerSynProduct,execute,start,productOptions:" + new Gson().toJson(productOptions)
                                        + ",vendorOptions:" + new Gson().toJson(vendorOptions) + ",eventName:" + eventName + ",index:" + flag);
                                ...
                                logger.info("XmagProductAllProducerControllerExecute,execute,end,productOptions:" + new Gson().toJson(productOptions)
    ...
    public void afterPropertiesSet() throws Exception {
        Facility.getInstance().setMicroProperties(microProperties);
        paramsMap = new HashMap<>();
        // apartment
        paramsMap.put("apartment_product_all_update", new MapUtils(new HashMap<String, Object>()).putData("url",
                "http://net13server2.net/TheApartmentAPI/MyApi/Productslist/GetProducts").putData("DBContext", "Default").putData("BrandId", "").putData(
                "StartIndex", "1").putData("EndIndex", "50").putData("Key", "RTs7g634sH").putData("CategoryId", "").putData("executor",
                (ThreadPoolExecutor) Executors.newCachedThreadPool()).putData("vendor_id", "20").putData("threadNum", "5").putData("eventName",
                "apartment_product_all_update").putData("fileUtils", new ApiDataFileUtils("apartment", "product_all_update")).getMap());

        paramsMap.put("apartment_product_delta_update", new MapUtils(new HashMap<String, Object>()).putData("url",
                "http://net13server2.net/TheApartmentAPI/MyApi/Productslist/GetProducts").putData("DBContext", "Default").putData("BrandId", "").putData(
                "StartIndex", "1").putData("EndIndex", "50").putData("Key", "RTs7g634sH").putData("CategoryId", "").putData("executor",
                (ThreadPoolExecutor) Executors.newCachedThreadPool()).putData("vendor_id", "20").putData("threadNum", "5").putData("redisStartIndex",
                "apartment_start_index_bydate").putData("redisEndIndex", "apartment_end_index_bydate").putData("eventName", "apartment_product_delta_update")
                .putData("fileUtils", new ApiDataFileUtils("apartment", "product_delta_update")).getMap());

        // dolci
        paramsMap.put("dolci_product_all_update", new MapUtils(new HashMap<String, Object>()).putData("url",
                "http://net13server2.net/dolcitrameapi/MyApi/Productslist/GetProducts").putData("DBContext", "Default").putData("BrandId", "").putData(
                "StartIndex", "1").putData("EndIndex", "50").putData("Key", "FwkQO9jAYJ").putData("CategoryId", "").putData("executor",
                (ThreadPoolExecutor) Executors.newCachedThreadPool()).putData("vendor_id", "37").putData("threadNum", "5").putData("eventName",
                "dolci_product_all_update").putData("fileUtils", new ApiDataFileUtils("dolci", "product_all_update")).getMap());

        paramsMap.put("dolci_product_delta_update", new MapUtils(new HashMap<String, Object>()).putData("url",
                "http://net13server2.net/dolcitrameapi/MyApi/Productslist/GetProducts").putData("DBContext", "Default").putData("BrandId", "").putData(
                "StartIndex", "1").putData("EndIndex", "50").putData("Key", "FwkQO9jAYJ").putData("CategoryId", "").putData("executor",
                (ThreadPoolExecutor) Executors.newCachedThreadPool()).putData("vendor_id", "37").putData("threadNum", "5").putData("redisStartIndex",
                "dolci_start_index_bydate").putData("redisEndIndex", "dolci_end_index_bydate").putData("eventName", "dolci_product_delta_update")
                .putData("fileUtils", new ApiDataFileUtils("dolci", "product_delta_update")).getMap());

        // mimma
        paramsMap.put("mimma_product_all_update", new MapUtils(new HashMap<String, Object>()).putData("url",
                "http://net13server3.it/mimmaninniapi/MyApi/Productslist/GetProducts").putData("DBContext", "Default").putData("BrandId", "").putData(
                "StartIndex", "1").putData("EndIndex", "50").putData("Key", "G4jKb0sFid").putData("CategoryId", "").putData("executor",
                (ThreadPoolExecutor) Executors.newCachedThreadPool()).putData("vendor_id", "12").putData("threadNum", "5").putData("eventName",
                "mimma_product_all_update").putData("fileUtils", new ApiDataFileUtils("mimma", "product_all_update")).getMap());

        paramsMap.put("mimma_product_delta_update", new MapUtils(new HashMap<String, Object>()).putData("url",
                "http://net13server3.it/mimmaninniapi/MyApi/Productslist/GetProducts").putData("DBContext", "Default").putData("BrandId", "").putData(
                "StartIndex", "1").putData("EndIndex", "50").putData("Key", "G4jKb0sFid").putData("CategoryId", "").putData("executor",
                (ThreadPoolExecutor) Executors.newCachedThreadPool()).putData("vendor_id", "12").putData("threadNum", "5").putData("redisStartIndex",
                "mimma_start_index_bydate").putData("redisEndIndex", "mimma_end_index_bydate").putData("eventName", "mimma_product_delta_update")
                .putData("fileUtils", new ApiDataFileUtils("mimma", "product_delta_update")).getMap());

        // mimma2
        paramsMap.put("mimma2_product_all_update", new MapUtils(new HashMap<String, Object>()).putData("url",
                "http://net13server3.it/mimmaninniapi/MyApi/Productslist/GetProducts").putData("DBContext", "Domini2").putData("BrandId", "").putData(
                "StartIndex", "1").putData("EndIndex", "50").putData("Key", "G4jKb0sFid").putData("CategoryId", "").putData("executor",
                (ThreadPoolExecutor) Executors.newCachedThreadPool()).putData("vendor_id", "39").putData("threadNum", "5").putData("eventName",
                "mimma2_product_all_update").putData("fileUtils", new ApiDataFileUtils("mimma2", "product_all_update")).getMap());

        paramsMap.put("mimma2_product_delta_update", new MapUtils(new HashMap<String, Object>()).putData("url",
                "http://net13server3.it/mimmaninniapi/MyApi/Productslist/GetProducts").putData("DBContext", "Domini2").putData("BrandId", "").putData(
                "StartIndex", "1").putData("EndIndex", "50").putData("Key", "G4jKb0sFid").putData("CategoryId", "").putData("executor",
                (ThreadPoolExecutor) Executors.newCachedThreadPool()).putData("vendor_id", "39").putData("threadNum", "5").putData("redisStartIndex",
                "mimma2_start_index_bydate").putData("redisEndIndex", "mimma2_end_index_bydate").putData("eventName", "mimma2_product_delta_update")
                .putData("fileUtils", new ApiDataFileUtils("mimma2", "product_delta_update")).getMap());

        // Spinnaker
        paramsMap.put("spinnaker_product_all_update", new MapUtils(new HashMap<String, Object>()).putData("url",
                "http://net13server.net/spinnakerapi/MyApi/Productslist/GetProducts").putData("DBContext", "Default").putData("BrandId", "").putData(
                "StartIndex", "1").putData("EndIndex", "50").putData("Key", "0mFLb4VtKS").putData("CategoryId", "").putData("executor",
                (ThreadPoolExecutor) Executors.newCachedThreadPool()).putData("vendor_id", "38").putData("threadNum", "5").putData("eventName",
                "spinnaker_product_all_update").putData("fileUtils", new ApiDataFileUtils("spinnaker", "product_all_update")).getMap());

        paramsMap.put("spinnaker_product_delta_update", new MapUtils(new HashMap<String, Object>()).putData("url",
                "http://net13server.net/spinnakerapi/MyApi/Productslist/GetProducts").putData("DBContext", "Default").putData("BrandId", "").putData(
                "StartIndex", "1").putData("EndIndex", "50").putData("Key", "0mFLb4VtKS").putData("CategoryId", "").putData("executor",
                (ThreadPoolExecutor) Executors.newCachedThreadPool()).putData("vendor_id", "38").putData("threadNum", "5").putData("redisStartIndex",
                "spinnaker_start_index_bydate").putData("redisEndIndex", "spinnaker_end_index_bydate").putData("eventName", "spinnaker_product_delta_update")
                .putData("fileUtils", new ApiDataFileUtils("spinnaker", "product_delta_update")).getMap());

        // Spinnaker Sanremo
        paramsMap.put("spinnakerSanremo_product_all_update", new MapUtils(new HashMap<String, Object>()).putData("url",
                "http://net13server.net/spinnakerapi/MyApi/Productslist/GetProducts").putData("DBContext", "Sanremo").putData("BrandId", "").putData(
                "StartIndex", "1").putData("EndIndex", "50").putData("Key", "0mFLb4VtKS").putData("CategoryId", "").putData("executor",
                (ThreadPoolExecutor) Executors.newCachedThreadPool()).putData("vendor_id", "40").putData("threadNum", "5").putData("eventName",
                "spinnakerSanremo_product_all_update").putData("fileUtils", new ApiDataFileUtils("spinnakerSanremo", "product_all_update")).getMap());

        paramsMap.put("spinnakerSanremo_product_delta_update", new MapUtils(new HashMap<String, Object>()).putData("url",
                "http://net13server.net/spinnakerapi/MyApi/Productslist/GetProducts").putData("DBContext", "Sanremo").putData("BrandId", "").putData(
                "StartIndex", "1").putData("EndIndex", "50").putData("Key", "0mFLb4VtKS").putData("CategoryId", "").putData("executor",
                (ThreadPoolExecutor) Executors.newCachedThreadPool()).putData("vendor_id", "40").putData("threadNum", "5").putData("redisStartIndex",
                "spinnakerSanremo_start_index_bydate").putData("redisEndIndex", "spinnakerSanremo_end_index_bydate").putData("eventName",
                "spinnakerSanremo_product_delta_update").putData("fileUtils", new ApiDataFileUtils("spinnakerSanremo", "product_delta_update")).getMap());

        // Spinnaker Portofino
        paramsMap.put("spinnakerPortofino_product_all_update", new MapUtils(new HashMap<String, Object>()).putData("url",
                "http://net13server.net/spinnakerapi/MyApi/Productslist/GetProducts").putData("DBContext", "Portofino").putData("BrandId", "").putData(
                "StartIndex", "1").putData("EndIndex", "50").putData("Key", "0mFLb4VtKS").putData("CategoryId", "").putData("executor",
                (ThreadPoolExecutor) Executors.newCachedThreadPool()).putData("vendor_id", "41").putData("threadNum", "5").putData("eventName",
                "spinnakerPortofino_product_all_update").putData("fileUtils", new ApiDataFileUtils("spinnakerPortofino", "product_all_update")).getMap());

        paramsMap.put("spinnakerPortofino_product_delta_update", new MapUtils(new HashMap<String, Object>()).putData("url",
                "http://net13server.net/spinnakerapi/MyApi/Productslist/GetProducts").putData("DBContext", "Portofino").putData("BrandId", "").putData(
                "StartIndex", "1").putData("EndIndex", "50").putData("Key", "0mFLb4VtKS").putData("CategoryId", "").putData("executor",
                (ThreadPoolExecutor) Executors.newCachedThreadPool()).putData("vendor_id", "41").putData("threadNum", "5").putData("redisStartIndex",
                "spinnakerPortofino_start_index_bydate").putData("redisEndIndex", "spinnakerPortofino_end_index_bydate").putData("eventName",
                "spinnakerPortofino_product_delta_update").putData("fileUtils", new ApiDataFileUtils("spinnakerPortofino", "product_delta_update")).getMap());
...
//			}
	...
	public void afterPropertiesSet() throws Exception {
		...
		paramsMap.put("mimma2_product_all_update",new MapUtils(new HashMap<String, Object>())
				...
				.putData("threadNum","5")
				.putData("eventName","mimma2_product_all_update")
				.putData("fileUtils",new ApiDataFileUtils("mimma2", "product_all_update")).getMap());

		paramsMap.put("mimma2_product_delta_update",new MapUtils(new HashMap<String, Object>())
				.putData("url","http://net13server3.it/mimmaninniapi/MyApi/Productslist/GetProducts")
				.putData("DBContext","Domini2")
				.putData("BrandId","")
				.putData("StartIndex","1")
				...
				.putData("vendor_id","39")
				.putData("threadNum","5")
				.putData("redisStartIndex","mimma2_start_index_bydate")
				.putData("redisEndIndex","mimma2_end_index_bydate")
		...
		paramsMap.put("spinnaker_product_all_update",new MapUtils(new HashMap<String, Object>())
				...
				.putData("threadNum","5")
				.putData("eventName","spinnaker_product_all_update")
				.putData("fileUtils",new ApiDataFileUtils("spinnaker", "product_all_update")).getMap());

		paramsMap.put("spinnaker_product_delta_update",new MapUtils(new HashMap<String, Object>())
				.putData("url","http://net13server.net/spinnakerapi/MyApi/Productslist/GetProducts")
				.putData("DBContext","Default")
				.putData("BrandId","")
				.putData("StartIndex","1")
				...
				.putData("vendor_id","38")
				.putData("threadNum","5")
				.putData("redisStartIndex","spinnaker_start_index_bydate")
