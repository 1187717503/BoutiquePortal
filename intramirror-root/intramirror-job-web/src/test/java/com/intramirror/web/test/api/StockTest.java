...
//        stockOptions.setProductCode("6000008490");
//        stockOptions.setQuantity("");
//        stockOptions.setSizeValue("UNI");
//
//        IStoreService storeService = new StoreServiceImpl();
//        ResultMessage resultMessage = storeService.handleApiStockRule(Contants.STOCK_QTY,0,stockOptions.getSizeValue(),stockOptions.getProductCode(),"7");
...
////            System.out.println(seasonService.selSeasonCodeByBoutiqueCode("14FW"));;
//            MappingCategoryService mappingCategoryService = new MappingCategoryService(conn);
////            System.out.println(mappingCategoryService.getMappingCategoryInfoByCondition("Women","Bags","Backpacks"));;
////            System.out.println("------"+mappingCategoryService.getDeafultCategory(17L,"Uomo","ACCESSORI"));
//
//            String originProductPath = "/Users/dingyifan/Downloads/c1.txt";
//            String revisedProductPath = "/Users/dingyifan/Downloads/c2.txt";
//
//            List<DiffRow> diffRows = FileUtil.CompareTxtByType(originProductPath,revisedProductPath);
//            System.out.println(JSONObject.toJSON(diffRows));
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//    }
