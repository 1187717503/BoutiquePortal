...
//        stockOptions.setProductCode("60000");
//        stockOptions.setQuantity("AB");
//        stockOptions.setSizeValue("AB");
//
//        IStoreService storeService = new StoreServiceImpl();
//        ResultMessage resultMessage = storeService.handleApiStockRule(Contants.STOCK_QTY,5,stockOptions.getSizeValue(),stockOptions.getProductCode());
