...
public class Product {
     ...
     */
    @Column
    public BigDecimal customer_rating;
    /**
     * 22:shop_rating
     */
    @Column
    public BigDecimal shop_rating;
    /**
     * 23:score
     */
    @Column
    ...
    @Column
    public BigDecimal min_retail_price;

    @Column
    public BigDecimal max_retail_price;
    ...
    @Column
    public BigDecimal max_boutique_price;
    @Column
    public BigDecimal min_boutique_price;
    @Column
    public BigDecimal max_im_price;
    @Column
    public BigDecimal min_im_price;

    @Column
    public BigDecimal preview_im_price;
    ...
    public BigDecimal getPreview_im_price() {
        return preview_im_price;
    }
