package pk.shoplus.service.request.impl;
 ...
 */
public class GetPostRequestService implements IGetPostRequest{

    private static Logger logger = Logger.getLogger(GetPostRequestService.class);
