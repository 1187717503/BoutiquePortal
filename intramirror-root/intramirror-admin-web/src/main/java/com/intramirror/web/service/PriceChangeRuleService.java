...
public class PriceChangeRuleService {
    ...
    public Map<String, Object> createPriceChangeRuleCategoryBrandBatch(Map<String, Object> map) throws Exception {
        ...
        List<PriceChangeRuleCategoryBrand> defaultPriceChangeRuleCategoryBrands = priceChangeRuleCategoryBrandService
                .queryPriceChangeRuleCategoryBrandByConditions(condition);
        ...
        if (list != null && list.size() > 0) {
            for (Map<String, Object> info : list) {
                ...
                logger.info(MessageFormat
                        .format("updatePriceChangeRuleDate price_change_rule_id:{0},valid_from:{1}", priceChangeRuleInfo.getPriceChangeRuleId(),
                                priceChangeRuleInfo.getValidFromStr()));
    ...
    public Map<String, Object> createPriceChangeRule(Map<String, Object> map) throws Exception {
        ...
        for (int i = 0; i < priceChangeRuleAllBrandListArray.size(); i++) {
            ...
            priceChangeRuleCategoryBrand.setLevel(Byte.valueOf("2"));
            priceChangeRuleCategoryBrand.setBrandId(0l);
            priceChangeRuleCategoryBrand.setDiscountPercentage(Long.valueOf("100") - priceChangeRuleAllBrandListArray.get(i).getAsJsonObject()
                    .get("discount_percentage").getAsLong());
            priceChangeRuleCategoryBrand.setExceptionFlag(0);
        ...
        for (int i = 0; i < priceChangeRuleCategoryListArray.size(); i++) {
            ...
            priceChangeRuleCategoryBrand.setDiscountPercentage(Long.valueOf("100") - priceChangeRuleCategoryListArray.get(i).getAsJsonObject()
                    .get("discount_percentage").getAsLong());
        ...
        for (int i = 0; i < priceChangeRuleProductListArray.size(); i++) {
            ...
            priceChangeRuleProduct.setDiscountPercentage(Long.valueOf("100") - priceChangeRuleProductListArray.get(i).getAsJsonObject()
                    .get("discount_percentage").getAsLong());
        ...
        for (int i = 0; i < priceChangeRuleGroupListArray.size(); i++) {
            ...
            priceChangeRuleGroup.setDiscountPercentage(Long.valueOf("100") - priceChangeRuleGroupListArray.get(i).getAsJsonObject().get("discount_percentage")
                    .getAsLong());
    ...
    public Map<String, Object> updatePriceChangeRule(Map<String, Object> map) throws Exception {
        ...
        for (int i = 0; i < priceChangeRuleAllBrandListArray.size(); i++) {
            ...
            PriceChangeRuleCategoryBrand priceChangeRuleCategoryBrand = new PriceChangeRuleCategoryBrand();
            priceChangeRuleCategoryBrand.setPriceChangeRuleCategoryBrandId(priceChangeRuleAllBrandListArray.get(i).getAsJsonObject()
                    .get("price_change_rule_category_brand_id").getAsLong());
            priceChangeRuleCategoryBrand.setDiscountPercentage(Long.valueOf("100") - priceChangeRuleAllBrandListArray.get(i).getAsJsonObject()
                    .get("discount_percentage").getAsLong());
